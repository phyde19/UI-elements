 ...
 const DUMMY_PLUGINS: Record<string, Plugin[]> = {
   ...
   legal: [
     ...
     { id: 'compliance-check', name: 'Compliance Check', icon: Code2 },
   ],
   data: [
     { id: 'db-query', name: 'Database Query', icon: Database },
     { id: 'pipeline-builder', name: 'Pipeline Builder', icon: GitMerge },
   ],
   marketing: [
     { id: 'content-analysis', name: 'Content Analysis', icon: BarChart },
     { id: 'trend-spotting', name: 'Trend Spotting', icon: TrendingUp },
   ],
 };
